#Érase una vez una tierra - una tierra de leche y miel, habitada por gente
#feliz y próspera. La gente pagaba impuestos, por supuesto, su felicidad
#tenía límites. El impuesto más importante, denominado Impuesto
#Personal de Ingresos (IPI, para abreviar) tenía que pagarse una vez al año
#y se evaluó utilizando la siguiente regla:

#1.-Si el ingreso del ciudadano no era superior a 85,528 pesos,
#el impuesto era igual al 18% del ingreso menos 556 pesos y 2 centavos
...
#una función llamada round() que hará el redondeo por ti,
